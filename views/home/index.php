<div class="jumbotron">
    ...
    <div class="content">
        <h1 class="ff-philosopher-bold text-white fs-1">Let's Make Your Best Trip Ever</h1>
        <p class="ff-philosopher text-white">The best travel for your journey respectful of the enviroment</p>
    </div>
</div>
